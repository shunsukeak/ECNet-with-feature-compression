...
def parse_args():
    ...
    parser.add_argument(
        "--dataset_dir", type=Path, default="./data/COCO/val2017", help="directory path to coco dataset"
    )
    parser.add_argument(
        "--anno_path", type=Path, default="./data/COCO/annotations_trainval2017/annotations/instances_val5k.json", help="json filename"
    )
    parser.add_argument(
        "--weights",
        type=Path,
